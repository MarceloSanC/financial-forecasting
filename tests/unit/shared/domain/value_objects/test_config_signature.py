...
Testa contra o `CanonicalJsonHasher` real (port injetado): o hasher é puro e
sem I/O, então não há fake — o hash aqui é o de produção (issue #70).
"""
...
def test_is_frozen() -> None:
    ...
    sig = ConfigSignature.compute(hasher=CanonicalJsonHasher(), config={"lr": 0.01})
