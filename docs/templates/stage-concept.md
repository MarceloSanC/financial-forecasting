...
keywords: [concept, <slug>, <termos do domínio>]
status: draft
created_at: YYYY-MM-DD
updated_at: YYYY-MM-DD
stage_id: N.M-<slug>
stage_title: <Título humano da Stage>
step_id: N                       # sequencial, sem zero-padding (1, 2, 15…)
step_title: <Título humano do Step que contém esta Stage>
depends_on: []
---
...
- [ ] Stage cabe em ~3–12 Tasks (ver [`CONVENTIONS.md`](../../CONVENTIONS.md) §6)?
